...
-   Convertir une string en nombre
-   Cibler une balise HTML
-   Injecter du contenu dans une balise
...
-   Conditions if
-   switch...case
-   JS / Générer un nombre aléatoire
-   JS / Convertir une chaîne de caractères en minuscules
...
-   Les tableaux #array
-   Les tableaux et méthodes qui permettant de les manipuler
-   Les fonctions
-   Vérifier qu'une valeur existe dans un tableau ou une string
-   Parcourir un tableau (boucles)
-   Gestionnaire d'événement
...
Le but de cette _application_ est d'avoir un carrousel de photos permettant de passer à la photo suivante, revenir à la photo précédente, afficher une photo aléatoire, et lancer un diaporama.

-   Cibler une balise HTML
-   Gestionnaire d'événement
-   Manipuler les classes CSS
-   Déclencher du code une fois la page HTML chargée
-   Les timers (interval et timeout)
-   Injecter du contenu dans une balise
-   Installer et utiliser FontAwesome
...
[Enoncé](https://haudrey.notion.site/Todo-List-nonc-9fbee974c14241ceb833124a5589d228)

-   Manipulation du DOM
-   localStorage

## Appels ajax en vanilla js et en jquery

[Enoncé](https://haudrey.notion.site/AJAX-nonc-9bdd2a1bfa574e7fbdda824805637c32)
Réaliser un appel AJAX en jQuery et en vanilla JS et traiter le résultat.

-   AJAX

## Agify

[Enoncé](https://haudrey.notion.site/Devine-mon-ge-nonc-3288fe9dcff54a50a4cb0b8d4278c46b)
Réaliser un appel AJAX vers une API en VanillaJS. Agify est une API qui propose l'âge en se basant sur un prénom !

-   AJAX

## Station météo

[Enoncé](https://haudrey.notion.site/Station-m-t-o-nonc-043eddbc3bfa45bc841155374116aa64)
Réaliser un appel AJAX en utilisant Fetch pour contacter l'API OpenWeatherMap.
...
[Enoncé](https://haudrey.notion.site/Saisie-de-repas-91673d02484c492c89e7b74ea15db003)
Créer une page qui permettra à l'utilisateur de voir une liste de repas déjà proposés par l'application, et de pouvoir rajouter ses propres suggestions.
...
[Enoncé](https://haudrey.notion.site/Masterpiece-nonc-9e44490e6da341ba9d0179ae003d40bf)
S'initier à l'orienté objet JavaScript.
...
[Enoncé](https://haudrey.notion.site/Painter-nonc-0fec2959cd804e15966ec05f1cab0c69)
Travailler l'orienté objet en réalisant une application de type Paint utilisant le canvas.
